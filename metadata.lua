return PlaceObj('ModDef', {
	...
	'last_changes', "1.09a ---- not released\n\nTODO: make a scoring for flare. Dont throw from near.\n\nGrenadier wont throw flares when in flanking behaviour\nGrenadier preferred stance will now be crouching\nSmall adjustments in the boost stats values\nSome adjustments in aim level decision making (due to changes in burst fire in gbo)\n\nMilitia units will now also receive stat boost. Can be disabled\n",
	'SpellCheck', true,
	'dependencies', {
