return PlaceObj('ModDef', {
	...
	'last_changes', "1.07b\n\n\nLowered the chance of enemies using Mobile attacks from a long distance \n\nFixed a vanilla function used to calc AOE zones for the AI. AI will be able to throw grenades even when it starts its turn further away from enemies. The same function may improve the ability of the AI to use Overwatch.",
	'SpellCheck', true,
	'dependencies', {
