return PlaceObj('ModDef', {
	...
	'last_changes', "1.09\n\nAdded a new option for difficulty. You now can control the amount of stat boosts the enemy gets. The default is Hardest, that is the same as when Boost Stats was enabled previously. Restart after applying this option.\n\nSmall tweaks to rocketeer\n",
	'SpellCheck', true,
	'dependencies', {
