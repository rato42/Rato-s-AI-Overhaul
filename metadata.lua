return PlaceObj('ModDef', {
	...
	'last_changes', "1.08\n\nAdded an incentive for AI to throw smokes at allies threatened by OW, and throw explosives/flash at enemies with a Prepared Attack\n\nSligthly changed grenade distribution\n\nRemoved some policies related to saving AP, as that seems to make enemies not perform actions in some cases\n\nTweaked the Sniper archetype\n\nEnemies can enter shooting stance as an end of turn action if they have enough AP\n\nMGs will try to get a little closer to use MG Setup",
	'SpellCheck', true,
	'dependencies', {
