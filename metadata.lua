return PlaceObj('ModDef', {
	...
	'last_changes', "1.08a\n\nSmall changes related to rocketeer archetype\nSmaller chances of rocketeer firing rocket inside buildings\n\nIf CUAE is enabled, the grenade distribution will be delegated to it. Added parameters for CUAE-based grenade distribution.\n\nAdded check for fire or gassed zones to stay in Shooting Stance decision making",
	'SpellCheck', true,
	'dependencies', {
