return PlaceObj('ModDef', {
	...
	'last_changes', '1.04 --- unreleased\n\nAdded an option to give general stat boost to enemies, based on their roles\nChanged the weights related to being exposed out of cover\nIncreased the probability enemy will seek cover while it is approaching the fight\nfixed the AI considering negative cover score as "cover"\nChanged the "Get closer" behaviour, to stop it from happening too close to the fight and leaving the AI exposed',
	'SpellCheck', true,
	'dependencies', {
