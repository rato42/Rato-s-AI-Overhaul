return PlaceObj('ModDef', {
	...
	'last_changes', "1.09b \n\n\nChanged some stats boosts params, Stormers will have a little less HP boost\n\nPanicked archetype will now also use the improved seek cover function\nMilitia now has its own parameters for stats boosts\n\nSome tweaks related to shotgun effective range estimation\nSome tweaks related to pindown (sniping)\nSome tweaks to Sniper preferred range \nSome tweaks to rocketeer",
	'SpellCheck', true,
	'dependencies', {
